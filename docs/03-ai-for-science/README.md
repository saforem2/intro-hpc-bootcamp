...
This is where it all comes together. The previous sections built up the
machinery — [neural networks](../01-neural-networks/), [Transformers and
LLMs](../02-llms/), and [training them at scale on
HPC](../01-neural-networks/4-distributed-training/index.qmd) — using
text as the running example. But the *same* models, trained on the
...
- ⚛️ **Molecules** — [SMILES
  strings](https://en.wikipedia.org/wiki/Simplified_Molecular_Input_Line_Entry_System)
  encoding chemical structure
- 🌊 **Physical systems** — lattice field theory, climate, and
  simulation data
