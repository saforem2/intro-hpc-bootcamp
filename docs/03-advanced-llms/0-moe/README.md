...
- [🧠 What is a Mixture of
  Experts?](#brain-what-is-a-mixture-of-experts)
- [👋 ① A toy that really runs](#wave-①-a-toy-that-really-runs)
  - [🔎 Peek inside the router](#mag_right-peek-inside-the-router)
  - [📦 Capacity factor](#package-capacity-factor)
- [🏗️ ② The real thing:
  DeepSeek-v3](#building_construction-②-the-real-thing-deepseek-v3)
  - [🧾 A torchtitan MoE config
    (display-only)](#receipt-a-torchtitan-moe-config-display-only)
  - [📊 Dense vs. MoE: params and
    FLOPs](#bar_chart-dense-vs-moe-params-and-flops)
- [🚀 ③ Scale it up: expert
  parallelism](#rocket-③-scale-it-up-expert-parallelism)
  - [🧭 EP vs. the parallelism you already
    know](#compass-ep-vs-the-parallelism-you-already-know)
  - [🛠️ Launch it with `ezpz`](#hammer_and_wrench-launch-it-with-ezpz)
...
<pre style="white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace">input shape : <span style="font-weight: bold">(</span><span style="color: #008080; text-decoration-color: #008080; font-weight: bold">12</span>, <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">8</span><span style="font-weight: bold">)</span>
</pre>

<pre style="white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace">output shape: <span style="font-weight: bold">(</span><span style="color: #008080; text-decoration-color: #008080; font-weight: bold">12</span>, <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">8</span><span style="font-weight: bold">)</span>
</pre>

<pre style="white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace">aux load-balancing loss: <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">1.0053</span>  <span style="font-weight: bold">(</span><span style="color: #008080; text-decoration-color: #008080; font-weight: bold">1.0</span> == perfectly balanced<span style="font-weight: bold">)</span>
</pre>

<pre style="white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace">total dispatches: <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">24</span>  <span style="font-weight: bold">(</span>== n_tokens x top_k = <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">24</span><span style="font-weight: bold">)</span>
</pre>

<pre style="white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace">
per-expert token counts <span style="font-weight: bold">(</span>top-<span style="color: #008080; text-decoration-color: #008080; font-weight: bold">2</span> of <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">4</span><span style="font-weight: bold">)</span>:
</pre>

<pre style="white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace">  expert <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">0</span>:  <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">6</span> tokens   <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">25.0</span>%  ######
</pre>

<pre style="white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace">  expert <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">1</span>:  <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">8</span> tokens   <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">33.3</span>%  ########
</pre>

<pre style="white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace">  expert <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">2</span>:  <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">5</span> tokens   <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">20.8</span>%  #####
</pre>

<pre style="white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace">  expert <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">3</span>:  <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">5</span> tokens   <span style="color: #008080; text-decoration-color: #008080; font-weight: bold">20.8</span>%  #####
</pre>
...
The aggregate `counts` above hide the actual *decisions* the router
made. Let’s open it up — nothing but a softmax over the gate logits
picks experts — and watch what changes as we make routing denser
(**top-1 → top-3**):
...
- Even this *untrained* router is lumpy: at top-1 one expert soaks up
  far more tokens than the idlest one. That imbalance is precisely what
  the **aux loss** (and DeepSeek-v3’s bias trick) exists to flatten.
...
> loss/bias that reshapes the router itself.
...
Figure 1: The DeepSeek-v3 MoE block: a **shared expert** (always active)
plus **8 of 256 routed experts**, combined additively.
...
Figure 2: Expert parallelism: each GPU owns a **subset of experts**.
Tokens are shuffled to the right GPU with an **all-to-all** (dispatch),
computed, then shuffled back (combine).
