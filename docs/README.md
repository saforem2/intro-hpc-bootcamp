...
- [👋 Welcome](#wave-welcome)
  - [🚦 Start here](#vertical_traffic_light-start-here)
...
> ### 🎯 Who this is for
>
> Students and researchers who are **new to AI, HPC, or both**. You
> don’t need prior machine-learning experience. Comfort with basic
> programming helps, but the first few pages ([Using
> Python](./00-intro-AI-HPC/3-python/), [Working with
> Data](./00-intro-AI-HPC/4-data/)) bring you up to speed.
...
Instructions for Running @ NERSC
</h3>
...
> ezpz test
>
> # 3. launch training (auto-detects SLURM srun / PBS mpiexec)
