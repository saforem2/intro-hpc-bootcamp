...
[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/saforem2/intro-hpc-bootcamp-2025/blob/main/docs/02-llms/advanced/index.ipynb)
[![](https://img.shields.io/badge/-View%20on%20GitHub-333333?style=flat&logo=github&labelColor=gray.png)](https://github.com/saforem2/intro-hpc-bootcamp-2025/blob/main/content/02-llms/advanced/index.qmd)
...
parallelism**. In [\[06\] Parallel
Training](../06-parallel-training/index.qmd) and the
[\[07\]](../07-shakespeare-example/index.qmd) /
[\[08\]](../08-shakespeare-example-colab/index.ipynb) Shakespeare
examples you put those ideas to work and pretrained a GPT from scratch.
...
flowchart LR
    subgraph FOUND["`Foundations`"]
        A("`[01] Distributed<br/>Training`")
        B("`[06] Parallel<br/>Training`")
        C("`[07]/[08]<br/>Shakespeare`")
    end
    subgraph ADV["`Advanced / Large-Scale`"]
        M("`[11] MoE`")
        P("`[12] Pretraining<br/>at Scale`")
        F("`[13] Fault<br/>Tolerance`")
        T("`[14] Mid- &<br/>Post-Training`")
        R("`[15] RL &<br/>Reasoning`")
    end
    A --> B --> C
    C --> M
    C --> P
...
Ready? Start with **[\[11\] Mixture of Experts & Expert
Parallelism](../11-moe/index.qmd)**.
