...
- [🤖 ③ Build an agentic reasoning
  model](#robot-③-build-an-agentic-reasoning-model)
...
[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/saforem2/intro-hpc-bootcamp-2025/blob/main/docs/02-llms/15-rl-and-reasoning/index.ipynb)
[![](https://img.shields.io/badge/-View%20on%20GitHub-333333?style=flat&logo=github&labelColor=gray.png)](https://github.com/saforem2/intro-hpc-bootcamp-2025/blob/main/content/02-llms/15-rl-and-reasoning/index.qmd)

In [\[14\] Mid- & Post-Training](../14-mid-post-training/index.qmd) you
...
Figure 1: The reasoning-model recipe: **base → SFT → RLVR**. DeepSeek-R1
...
Figure 2: The RLVR reasoning loop. **rollout → verify → advantage →
update**, repeated. The only human input is the verifier; the reasoning
inside `<think>` is discovered by the policy.
...
- Previous: [\[14\] Mid- &
  Post-Training](../14-mid-post-training/index.qmd) — CPT + SFT with
  TRL/PEFT.
