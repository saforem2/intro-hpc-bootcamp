...
code. Set the cache to a filesystem that supports locking **before** importing
`transformers`:
...
`/lus/flare/...` (Aurora). If the model is already cached, adding
`HF_HUB_OFFLINE=1` skips the lock path entirely.
:::
