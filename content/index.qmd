...
description: "Homepage for Sam Foreman's Intro to HPC Bootcamp Project"
categories:
  - ai4science
  - hpc
  - llm
...
- 🏡 [Intro to {AI, HPC} for Science/](./)
    ...
    - 📂 [**\[01\] Neural Networks/**](./01-neural-networks/)
        ...
        - 📗 [\[01.2\] Convolutional Networks](./01-neural-networks/3-conv-nets/)
        - 📗 [\[01.3\] Representation Learning](./01-neural-networks/4-representation-learning/)
        - 📄 [\[01.4\] Distributed Training](./01-neural-networks/5-distributed-training/)
    ...
    - 📂 [**\[02\] Large Language Models**](./02-llms/)
        ...
        - 📗 [\[02.2\] Shakespeare Example (colab)](./02-llms/08-shakespeare-example-colab/)
        - 🪶 [\[02.3\] Shakespeare from Scratch (ezpz)](./02-llms/09-shakespeare-ezpz/)
...
<details closed><summary><h2> 🏔️ Instructions for Running @ NERSC</h2></summary>
