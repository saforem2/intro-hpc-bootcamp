...
- 🏡 [Intro to {AI, HPC} for Science/](./)
    ...
    - 📂 [**\[02\] Large Language Models**](./02-llms/)
        ...
        - 🚀 [**Advanced / Large-Scale LLMs**](./02-llms/advanced/)
            - 📗 [\[11\] Mixture of Experts & Expert Parallelism](./02-llms/11-moe/)
            - 📗 [\[12\] Pretraining at Scale](./02-llms/12-pretraining-at-scale/)
            - 📗 [\[13\] Fault-Tolerant Training](./02-llms/13-fault-tolerant-training/)
            - 📗 [\[14\] Mid- & Post-Training](./02-llms/14-mid-post-training/)
            - 📗 [\[15\] RL & Reasoning Models](./02-llms/15-rl-and-reasoning/)
