...
1. Clone [wordplay](https://github.com/saforem2/wordplay) into **your own**
...
1. Setup [wandb](https://wandb.ai) (optional -- it prompts for an API key;
   skip it if you would rather not track the run):

    ```bash
    wandb login            # or, to skip tracking entirely:
    export WANDB_DISABLED=1
    ```

1. Install [`wordplay`](https://github.com/saforem2/wordplay):

    ```bash
    python3 -m pip install -e "."
    ```

1. Run `ezpz test` (simple test to verify distributed functionality):
