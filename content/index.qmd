...
```bash
# clone into the shared project space so your work is with the group's
cd /global/cfs/cdirs/m4388/projects/project8
git clone https://github.com/saforem2/intro-hpc-bootcamp
cd intro-hpc-bootcamp
```

Prefer to keep it in your own space? `cd $SCRATCH` (or `$HOME`) first — the
clone works anywhere, and nothing below depends on where it lives.
