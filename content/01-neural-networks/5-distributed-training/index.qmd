...
- [**\[02\] Intro to LLMs**](../../02-llms/00-intro-to-llms/index.qmd) — transformers, tokenization, attention, and building a mini-LLM.
- [**\[02\] Parallel Training**](../../02-llms/06-parallel-training/index.qmd) — hands-on distributed LLM training on HPC.
