...
**Prerequisites:** the [00] primers on [Python](../3-python/index.qmd) and
[working with data](../4-data/index.qmd) — you should be comfortable reading a
...
[Python primer](../3-python/index.qmd)):
