...
::: {#fig-gpu-lowlabel .column-page}

![](assets/gpu-lowlabel.svg){width="70%" fig-align="center"}

Low-label accuracy on CIFAR-10, measured on an A100. Contrastive-pretrained
features (probed with a linear head) beat training the same network from scratch
at every label count — by **+10 to +13 points** in the scarce-label regime.
:::
...
: Contrastive pretraining vs. from-scratch, CIFAR-10, 1× A100. {.striped}
