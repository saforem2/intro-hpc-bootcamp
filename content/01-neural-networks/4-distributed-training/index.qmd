...
- In **Tensor Parallelism** each GPU processes only a slice of a tensor and only
...
- [**\[2\] Intro to LLMs**](../../02-llms/0-intro-to-llms/index.qmd) — transformers, tokenization, attention, and building a mini-LLM.
- [**\[2\] Parallel Training**](../../02-llms/1-parallel-training/index.qmd) — hands-on distributed LLM training on HPC.
- [**\[3\] Advanced / Large-Scale LLMs**](../../03-advanced-llms/index.qmd) — MoE, pretraining at scale, fault tolerance, and RL.
:::

<!-- Trimmed: general LLM explainer (emergent abilities, life-cycle, forward
     pass, text generation) moved conceptually to [2] Intro to LLMs to keep
...
➡️ [**\[2\] Hands-On: Launching a Distributed Run**](../../02-llms/1-parallel-training/index.qmd)
