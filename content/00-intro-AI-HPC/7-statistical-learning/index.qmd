...
Watch the algorithm converge: each frame is one iteration — points recolor as
they're reassigned to the nearest centroid (★), and the centroids drift into
place. Drag the slider or hit ▶:
